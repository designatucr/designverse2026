    ...
    <div className={`relative ${inter.className}`}>
      ...
      >
          ...
          <div className="flex flex-col items-start gap-8 md:flex-row md:gap-12">
            <div className="relative flex-1">
              <div className="relative bg-white p-6 py-24 text-landing-brown-400 shadow-[5px_5px_5px_rgba(0,0,0,0.3)] sm:p-12">
                ...
                <p className="text-sm font-medium lg:text-lg xl:text-xl">
            ...
            <div className="relative -top-20 flex w-1/2 max-w-96 items-center justify-center place-self-end sm:w-1/2 sm:place-self-end md:w-1/3 md:pt-72 lg:w-1/3 lg:pt-[40%] xl:w-1/3 xl:pt-0">
        ...
        <Image
          src={matcha}
          alt="matcha"
          className="absolute bottom-[46%] right-[33%] z-40 hidden w-1/4 max-w-32 sm:right-[30%] sm:w-1/6 md:right-[25%] md:max-w-32 lg:right-[30%] lg:block lg:max-w-36 xl:right-[25%] xl:max-w-40"
        />
        <Image
          src={taiyaki}
          alt="taiyaki"
          className="absolute bottom-[46%] right-[40%] z-40 hidden w-1/4 max-w-28 sm:right-[45%] sm:w-1/6 md:max-w-32 lg:right-[50%] lg:block lg:max-w-36 xl:right-[35%]"
        />
      </section>
      <div className="relative">
        <div className="z-30 -mt-64 flex h-32 w-full items-center bg-landing-orange-200 md:-mt-[50%] lg:-mt-[40%] xl:-mt-[30%]" />
