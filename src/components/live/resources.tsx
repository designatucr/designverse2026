...
const shelfClipPath = [
  ...
  "[clip-path:polygon(-20%_0%,120%_0%,120%_100%,-20%_100%)]",
  "[clip-path:polygon(0%_0%,88%_0%,100%_100%,0%_100%)]",
];

const Resources = () => {
  return (
    <div className="flex flex-col items-center justify-center p-6 font-poppins md:p-16">
        ...
        <div className="relative grid w-full grid-cols-1 gap-0 border-x-2 border-white lg:grid-cols-3">
          {resources.map(({ link, title, description, image }, index) => (
            <div
              ...
              key={index}
            >
              <div className="relative flex h-[20vh] w-full flex-col items-center justify-center bg-landing-glass-100/15 md:h-[25vh] lg:h-[30vh]">
                <Link
                  href={link}
                  target="_blank"
                ...
                >
                  <Image
                    src={image}
                    className="md:w-42 sm:w-30 w-24 rounded-full transition hover:scale-105 hover:cursor-pointer lg:w-32"
                    alt="Resource"
                  />
                </Link>
                <div
                  className={`sm:h-21 absolute -left-px bottom-0 -z-10 h-[32%] w-[calc(100%+2px)] translate-y-[1%] bg-landing-brown-400 md:h-[32%] lg:block ${shelfClipPath[index]} hidden`}
                />
              ...
              <div className="flex h-2/3 w-full flex-col items-center justify-center bg-landing-brown-300 px-8 text-center text-white lg:px-10">
                <div className="mb-6 font-inter text-xl font-bold md:text-3xl">
                  {title}
                </div>
                <div className="text-center font-inter lg:text-lg">
                  {description}
                </div>
              </div>
            </div>
          ...
          <div className="relative flex h-[20vh] w-full flex-col items-center justify-center bg-landing-glass-100/15 sm:h-[20vh] md:h-[40vh] lg:hidden">
            <Image
              src={Turtle}
              alt="Turtle Bread"
